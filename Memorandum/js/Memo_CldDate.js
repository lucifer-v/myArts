/*
  ...
  */
function Memo_CldDate(_dateStr, _splitter){
		//defaultArgs--start
		var defaultArgs = {
				_splitter : ""
		};
...
Memo_CldDate.prototype.leapYrMonths=[31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
Memo_CldDate.prototype.nonLeapYrMonths=[31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
...
/*
  ...
  */
Memo_CldDate.prototype.paddingZero=function(_num){
...
/*
  ...
  *		false：不是闰年
  */
Memo_CldDate.prototype.isLeapYear = function(_year){
		if(	(0 == _year%400) ||
...
*/
Memo_CldDate.prototype._diffDays=function(){
		var iDiffDay=0;
...
/*
  ...
  *		[0=星期日|1=星期一|...]
  */
Memo_CldDate.prototype._calculateWeek=function(_diffDay){
...
/*
  ...
  *@返回值：日期字符串
  */
Memo_CldDate.prototype.toString=function(){
...
/*
  ...
  */
Memo_CldDate.prototype.addDay=function(){
		...
		return new Memo_CldDate(nextDayDateStr, this.m_splitter);
}//end func-addDady
...
/*
  ...
  *		[1]-年份不能超过2100，不能小于1900
  */
Memo_CldDate.prototype.minusDay=function(){
		var		year = this.m_year,
				month = this.m_month,
					  day = this.m_day;
...
/*
  ...
  *@约束:year不能大于2100
  */
Memo_CldDate.prototype.addMonth = function(){
		var		 year = this.m_year,
			     month = this.m_month,
					 day  =  this.m_day;
		...
		return new Memo_CldDate("" + year +this.m_splitter + this.paddingZero(month) + 
...
/*
  ...
  */
Memo_CldDate.prototype.minusMonth=function(){
		var  year	  = this.m_year,
				month = this.m_month,
				day       = this.m_day;
...
/*
  ...
  */
Memo_CldDate.prototype.addYear=function(){
		var year		= this.m_year,
				month	= this.m_month,
				day			= this.m_day;
...
/*
  ...
  *@约束:如果m_year<1900则m_year=1900
  */
Memo_CldDate.prototype.minusYear = function(){
		var year		= this.m_year,
			   month	= this.m_month,
			   day			= this.m_day;
...
/*
  ...
  *@返回:CldDate对象
  */
Memo_CldDate.prototype.getLastDayDate = function(){
		...
		return new Memo_CldDate(lastDayDateStr, this.m_splitter);
