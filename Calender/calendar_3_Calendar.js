...
Calendar.prototype.buildCalendarGrid_en=function(_lang){
		...
		var htmlStr = '<table style="border:1px solid #000;text-align:center;">';
...
Calendar.prototype.buildCalendarGrid_cn=function(_lang){
		...
		var htmlStr = '<table class="cld_calendarGrid">';
...
/*
  ...
  *返回值：CldDate对象
  */
Calendar.prototype.getFirstDateObj = function(){
...
/*
  ...
  *返回值：CldDate对象
  */
Calendar.prototype.getLastDateObj = function(){
